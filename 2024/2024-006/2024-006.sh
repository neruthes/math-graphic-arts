...
for i in 10000; do
    PROG=$i node 2024/2024-006/2024-006.js
done
...
mkdir -p .tmp
find 2024/2024-006/svgout -name '*.svg' | sort -V | grep -v 10000 > .tmp/svglist
cat .tmp/svglist
...
find 2024/2024-006/svgout -name '*.svg' | while read -r line; do
    makepng "$line"
done



# bash 2024/2024-006/2024-006.sh
